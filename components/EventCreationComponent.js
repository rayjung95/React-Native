...
import { createEvent, getUserAddress, setNewAddress, giveUserLocation, locationSelected } from "../actions/eventsActions";
...
export class EventCreationComponent extends React.Component {
  ...
  returnData(locationName, coordinate) {
    
    console.log("user has : ", this.props.userHasPicked);

    this.setState({ location: locationName, coordinate: coordinate });
    console.log("LOC IS", this.state.location);
  }
    ...
    return (
      <View style={styles.outer}>
        ...
        <View style={{
          ...
          >
            {!this.props.userHasPicked && <Text style={styles.grey}>Location</Text>}
            {this.props.userHasPicked && <Text style={styles.black}>{this.props.userAddress}</Text>}
...
const mapStateToProps = (state) => {
  ...
  return { events, userLocation, userAddress, userHasPicked }
};

const mapDispatchToProps = dispatch => (
  bindActionCreators({
    createEvent,
    getUserAddress, setNewAddress, giveUserLocation,
    locationSelected
  }, dispatch)
);
