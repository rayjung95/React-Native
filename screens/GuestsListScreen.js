        ...
        this.setState({
            guestsListData:[
                {   
                    ...
                    'imageURL': 'https://www.ienglishstatus.com/wp-content/uploads/2018/04/Anonymous-Whatsapp-profile-picture.jpg'
                },
                {
                    'id':'002',
                    'guestName':'Something',
                            ...
                            <View style={styles.headerContainer}>
                                <View style={{flex:1, alignItems:'center'}}>
                                    <TouchableOpacity onPress={() => this.props.navigation.navigate('EventDetails')}>
                                        <Image style={{width:window.height/38, height:window.height/38, resizeMode:'contain'}} source={require('../assets/Icons/go-back-left-arrow/go-back-left-arrow.png')}/>
                                    </TouchableOpacity>
                                </View>
                                <View style={{flex:5, alignItems:'flex-start',}}>
                                ...
                                <View style={{flex:1, alignItems:'center'}}>
                                    <TouchableOpacity onPress={()=>this.props.navigation.navigate('GuestsListEdit',{guests:this.state.guestsListData})}>
